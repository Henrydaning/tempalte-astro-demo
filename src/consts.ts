...
export const SIDEBAR: Sidebar = {
	en: {
		'记录是学习的开始': [
			...
			{ text: '02极客时间Vue课程学习和问题笔记', link: 'en/second' },
			{ text: '03 掘金算法课程学习和问题笔记', link: 'en/third' },
			{ text: '04 掘金 Uniapp 课程和Taro或原生小程序学习笔记', link: 'en/fourth' },
			{ text: '05leetcode 刷题记录每周', link: 'en/fifth' },
			{ text: '06 极客时间 Node 全栈记录', link: 'en/sixth' },
			{ text: '07React 学习常见问题和笔记记录', link: 'en/seventh' },
			{ text: '08vue 常见问题和学习记录', link: 'en/eighth' },
			{ text: '09book 前端进阶知识学习图书笔记', link: 'en/ninth' },
			{ text: '10book 前端开发设计模式和开发实战笔记', link: 'en/tenth' },
			{ text: '11elementplus 经典源码和实战学习和问题笔记', link: 'en/eleventh' },
